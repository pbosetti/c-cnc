...
publish(M, 'c-cnc/status/error', num2str(block.InputPort(1).Data(1)));
pos_msg = sprintf('%f,%f,%f', block.InputPort(2).Data(1), block.InputPort(2).Data(2), block.InputPort(2).Data(3));
publish(M, 'c-cnc/status/position', pos_msg);
